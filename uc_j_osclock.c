 ...
 */
JNIEXPORT jlong JNICALL Java_uc_j_OSClock_currentTimeMillis(JNIEnv *env, jclass cls) {
#if defined _WIN32
	FILETIME ft;
	ULARGE_INTEGER li;
 ...
 */
JNIEXPORT jlong JNICALL Java_uc_j_OSClock_nanoTime(JNIEnv *env, jclass cls) {
#if defined _WIN32
 ...
 */
JNIEXPORT jlong JNICALL Java_uc_j_OSClock_getEpochMillis(JNIEnv *env, jclass cls) {
#if defined _WIN32
	FILETIME ft;
	ULARGE_INTEGER li;
	GetSystemTimeAsFileTime(&ft);
